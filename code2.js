...
{for(var i = 0, len = gdjs.ScoreCode.GDbunObjects1.length ;i < len;++i) {
    ...
    gdjs.ScoreCode.GDcoinsObjects1[i].getBehavior("Text").setText(gdjs.evtTools.common.toString(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0))) + " Buns");
}
}}
